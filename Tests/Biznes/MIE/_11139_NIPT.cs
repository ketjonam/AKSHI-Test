...
[Category("MIE")]
[Category("11139")]
public class _11139_NIPT : BiznesTestBase
{
    protected override string ServiceCode => "11139";
    protected override string? ServiceTitle => "Aplikim_i_Ri_Biznes_11139";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName =
        "Aplikim për reflektimin e ndryshimit ose shtesës së përfaqësuesit/përfaqësuesve ligjor, në licencën e shoqërisë në fushën e studimit e projektimit dhe/ose mbikëqyrjes e kolaudimit";
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle, bool required)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-11139"));
