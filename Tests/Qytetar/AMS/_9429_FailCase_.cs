...
[Category("9429")]
[Category("FailCase")]
public class _9429_FailCase_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "9429";
    protected override string? ServiceTitle => "LicensimiAdministratoreveTeFalimentit_FailCase_ReturnsUiMessage";
