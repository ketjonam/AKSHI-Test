...
[Category("AQTN")]
[Category("13826")]
public class _13826_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "13826";
    protected override string? ServiceTitle => "Dhenie_tellesie_sondave_puseve";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName = "Dhënie e thellësisë së sondave e puseve";
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-13826"));
