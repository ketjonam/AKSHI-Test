...
[Category("AQTN")]
[Category("13829")]
public class _13829_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "13829";
    protected override string? ServiceTitle => "Plansheta_Gjeodezike";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName = "Dhënie plansheta gjeodezike";
    ...
    public void Plansheta_Gjeodezike()
    {
        ...
        IWebElement formatiHartes = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("formatiHartes")));
        ...
        Assert.That(driver.FindElement(By.CssSelector("label[for='formatiHartes']")).Text,
            Does.Contain("*"));
        ...
        formatiHartes = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("formatiHartes")));
        ...
        FillInput(specifikimi, "test");
        Assert.That(specifikimi.GetAttribute("value").Trim(), Is.EqualTo("test"));
        ...
        teTjera = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("teTjera")));
        FillInput(teTjera, "test");
        Assert.That(teTjera.GetAttribute("value").Trim(), Is.EqualTo("test"));
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-13829"));
