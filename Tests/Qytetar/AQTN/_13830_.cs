...
[Category("AQTN")]
[Category("13830")]
public class _13830_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "13830";
    protected override string? ServiceTitle => "PunimeGjeologjikeGjeofizike";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName =
        "Dhënie e studimeve e punimeve gjeologjike e gjeofizike";
    ...
    public void PunimeGjeologjikeGjeofizike()
    {
        ...
        Log("Assert forma e dokumentit arkivor");
        IWebElement formaLabel = wait.Until(ExpectedConditions.ElementIsVisible(
            By.XPath("//label[contains(normalize-space(),'Forma e dokumentit arkivor')]")));
        Assert.That(formaLabel.Text, Does.Contain("*"));

        AssertDocumentFormCheckbox("cbFleteProjekti", "fleteProjekti", "Fletë projekti");
        AssertDocumentFormCheckbox("cbShkresore", "shkresore", "Shkresore");
        ...
        Assert.That(vitiHartes.GetAttribute("min"), Is.EqualTo("1"));
        Assert.That(vitiHartes.GetAttribute("max"), Is.EqualTo("9999"));
        ...
        SafeClick(By.Id("cbShkresore"));
        Assert.That(wait.Until(ExpectedConditions.ElementExists(By.Id("cbShkresore"))).Selected, Is.True);
    ...
    private void AssertDocumentFormCheckbox(string id, string name, string expectedLabel)
    {
        ...
        Assert.That(checkbox.GetAttribute("name"), Is.EqualTo(name));
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-13830"));
