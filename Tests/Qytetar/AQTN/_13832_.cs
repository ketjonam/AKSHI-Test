...
[Category("AQTN")]
[Category("13832")]
public class _13832_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "13832";
    protected override string? ServiceTitle => "Projekteve_Ujesjellesve_Kanalizimeve";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName =
        "Dhënie fletëve koreografike të projekteve të ujësjellësa-kanalizimeve";
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-13832"));
