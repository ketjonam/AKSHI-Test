...
[Category("AQTN")]
[Category("13833")]
public class _13833_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "13833";
    protected override string? ServiceTitle => "Projekteve_Ujesjellesve_Kanalizimeve_KurJepenPjesore";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName =
        "Dhënie e fletëve koreografike të projekteve të ujësjellësa-kanalizimeve (kur jepen pjesore)";
    ...
    public void Projekteve_Ujesjellesve_Kanalizimeve_KurJepenPjesore()
    {
        ...
        IWebElement Step1Title = WaitForStepTitle("INFORMACTION MBI APLIKANTIN");
        Assert.That(Step1Title.Text.Trim().ToUpperInvariant(),
            Does.StartWith("INFORMACTION MBI APLIKANTIN"));
        ...
        IWebElement vitiStudimit = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("vitiStudimit")));
        ...
        Assert.That(driver.FindElement(By.CssSelector("label[for='vitiStudimit']")).Text,
            Does.Not.Contain("*"));

        IWebElement autoriProjektit = wait.Until(ExpectedConditions.ElementIsVisible(
            By.Id("autoriProjektit")));
        ...
        IWebElement nrFleteve = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("nrFleteve")));
        ...
        IWebElement teDhenaTjera = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("teDhenaTjera")));
        Assert.That(teDhenaTjera.GetAttribute("maxlength"), Is.EqualTo("120"));
        Assert.That(teDhenaTjera.GetAttribute("value").Trim(), Is.EqualTo(string.Empty));
        Assert.That(driver.FindElement(By.CssSelector("label[for='teDhenaTjera']")).Text,
            Does.Not.Contain("*"));
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-13833"));
