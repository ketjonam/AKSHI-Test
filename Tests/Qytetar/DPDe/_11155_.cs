...
public class _11155_ : QytetarNidJ557TestBase
{
    ...
    public void LejeDrejtimiPerMjetetLundruese()
    {
        ...
        IWebElement contactTooltip = wait.Until(ExpectedConditions.ElementExists(
            By.CssSelector("h4.text-uppercase span[data-bs-toggle='tooltip']")));
        AssertTooltipText(contactTooltip,
            "Informacioni i dhënë duhet të jetë i saktë pasi ju do të kontaktoheni nëpërmjet adresës elektronike dhe numrit të telefonit");
        ...
        AssertReadOnlyValue("Qyteti", "TIRANË");
        AssertReadOnlyValue("Rrethi", "TIRANË");
