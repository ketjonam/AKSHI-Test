...
public class _14936_ : QytetarNidJ557TestBase
{
    ...
    public void CertifikateSipasKonventes()
    {
        ...
        FillInput(FindInputByName("postalCode"), "2501");
        FillInput(FindInputByName("telFiks"), "055220000");
        Assert.That(FindInputByName("postalCode").GetAttribute("value").Trim(), Is.EqualTo("2501"));
        Assert.That(FindInputByName("telFiks").GetAttribute("value").Trim(), Is.EqualTo("055220000"));
