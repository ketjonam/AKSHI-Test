...
[Category("DPSHTRR")]
[Category("10094")]
public class _10094_ : QytetarNidJ257TestBase
{
    protected override string ServiceCode => "10094";
    protected override string? ServiceTitle => "Regjistrim_Mjeti";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName = "Aplikim për regjistrim mjeti/motomjeti";
    ...
    private static readonly (string Id, string Title)[] ApplicantDocuments =
    {
        ...
        ("DAVCUSTUpload", "Dokument zhdoganimi i mjetit DAV"),
        ("DTOMPNUpload", "Dokumenti teknik i origjinës së mjetit i përkthyer dhe noterizuar"),
        ("DVFITPRUpload", "Dokumenti i fitimit të pronësisë"),
    ...
    public void Regjistrim_Mjeti()
    {
        ...
        FillInput(vin, "testautomation");
        FillInput(licenceNo, "test1");
        SelectByValue(vehicleType, "MT");
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-10094"));
