...
[Category("DPSHTRR")]
[Category("10098")]
public class _10098 : QytetarNidJ257TestBase
{
    protected override string ServiceCode => "10098";
    protected override string? ServiceTitle => "Aplikim_Per_Nderrim_LejeQarkullimi";
    ...
    private static readonly (string Id, string Title)[] ApplicantDocuments =
    {
        ...
        ("KQUpload", "Kontratë qiramarrje"),
        ("LQEUpload", "Leje Qarkullimi Ekzistuese"),
        ("LQMBUpload", "Leje qendrimi lëshuar nga MB"),
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-10098"));
