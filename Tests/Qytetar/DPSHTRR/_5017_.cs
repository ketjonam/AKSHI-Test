...
public class _5017_ : QytetarNidJ257TestBase
{
    ...
    private const string ExpectedServiceName = "Gjobat e kontrollit teknik vjetor të automjeteve";
    private const string ExpectedTitle = "Lista e automjeteve në zotërim";
    private const string ExpectedTarga = "AB838HR";
    private const string ExpectedMarka = "DAIMLER CHRYSLER";
    ...
    public void GjobatKontrollitTeknik()
    {
        ...
        IWebElement gjobatAlert = wait.Until(ExpectedConditions.ElementIsVisible(
            By.CssSelector("div.alert[role='alert']")));
        ...
        Assert.That(
            ...
            Is.EqualTo($"Nuk ka të dhëna për gjoba për automjetin tip  '{ExpectedMarka}' me targë '{ExpectedTarga}'!"));
    ...
    private IWebElement WaitForVehicleRow(string expectedTarga)
    {
        ...
        return dataWait.Until(d =>
        {
            try
            {
                ...
                string targa = cells[0].Text.Trim();
