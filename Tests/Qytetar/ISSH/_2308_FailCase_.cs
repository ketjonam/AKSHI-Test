...
[Category("2308")]
[Category("FailCase")]
public class _2308_FailCase_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "2308";
    protected override string? ServiceTitle => "AplikimPerPensionTeParakoheshemUshtarak_FailCase_ReturnsUiMessage";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;

    [Test]
    public void AplikimPerPensionTeParakoheshemUshtarak_FailCase_ReturnsUiMessage()
    {
        ...
        Log("STIMULIM FAIL: nuk zgjidhen dokumente (qëllimisht).");
        Thread.Sleep(1000);

        Log("Kliko Dergo pa zgjedhur dokumente");
        SafeClick(By.CssSelector("button.ealb-btn-continue"));

        By successHeadlineBy = By.XPath(
            "//h5[contains(normalize-space(.),'APLIKIMI JUAJ U DËRGUA ME SUKSES') or contains(normalize-space(.),'APLIKIMI JUAJ U DERGUA ME SUKSES')]");
