...
public class _6165_ : QytetarNidF602TestBase
{
    ...
    public void MasatPaterhequraInvaliditeti()
    {
        ...
        Assert.That(serviceName.Text.Trim(), Is.EqualTo("Masat e patërhequra të pensionit të invaliditetit (KMCAP)"),
        ...
        IWebElement emptyMessage = wait.Until(ExpectedConditions.ElementIsVisible(
            By.XPath("//div[contains(@class,'text-center') and normalize-space()='Nuk gjendet asnjë pension!']")));
