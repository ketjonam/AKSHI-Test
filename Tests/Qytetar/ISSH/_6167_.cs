...
[Category("ISSH")]
[Category("6167")]
public class _6167_ : QytetarNidF602TestBase
{
    protected override string ServiceCode => "6167";
    protected override string? ServiceTitle => "MasatPaterhequraPensioniPleqerise";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    [Test]
    public void MasatPaterhequraPensioniPleqerise()
    {
        ...
        Assert.That(serviceName.Text.Trim(), Is.EqualTo("Masat e patërhequra të pensionit të pleqërisë"),
        ...
        IWebElement emptyMessage = wait.Until(ExpectedConditions.ElementIsVisible(
            By.XPath("//div[contains(@class,'text-center') and normalize-space()='Nuk ka të dhëna të pensionit të pleqërisë!']")));
        Assert.That(emptyMessage.Displayed, Is.True, "Mesazhi nuk eshte visible");
        Assert.That(emptyMessage.Text.Trim(),
            Is.EqualTo("Nuk ka të dhëna të pensionit të pleqërisë!"));
