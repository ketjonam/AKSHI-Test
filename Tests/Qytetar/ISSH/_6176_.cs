...
[Category("ISSH")]
[Category("6176")]
public class _6176_ : QytetarNidF602TestBase
{
    protected override string ServiceCode => "6176";
    protected override string? ServiceTitle => "MasatPaterhequraPensioniFamiljar";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    [Test]
    public void MasatPaterhequraPensioniFamiljar()
    {
        ...
        Assert.That(serviceName.Text.Trim(), Is.EqualTo("Masat e patërhequra të pensionit familjar"),
        ...
        IWebElement emptyMessage = wait.Until(ExpectedConditions.ElementIsVisible(
            By.XPath("//div[contains(@class,'text-center') and normalize-space()='Nuk gjendet pension i patërhequr!']")));
        Assert.That(emptyMessage.Displayed, Is.True, "Mesazhi nuk eshte visible");
        Assert.That(emptyMessage.Text.Trim(),
            Is.EqualTo("Nuk gjendet pension i patërhequr!"));
