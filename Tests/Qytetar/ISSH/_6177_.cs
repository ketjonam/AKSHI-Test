...
[Category("ISSH")]
[Category("6177")]
public class _6177_ : QytetarNidF602TestBase
{
    protected override string ServiceCode => "6177";
    protected override string? ServiceTitle => "MasatPaterhequraDeshmorAtdheut";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    [Test]
    public void MasatPaterhequraDeshmorAtdheut()
    {
        ...
        Assert.That(serviceName.Text.Trim(),
            Is.EqualTo("Masat e patërhequra të shpërblimit financiar nga statusi \"Dëshmor i Atdheut\""),
