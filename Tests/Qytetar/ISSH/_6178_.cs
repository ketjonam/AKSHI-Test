...
[Category("ISSH")]
[Category("6178")]
public class _6178_ : QytetarNidF602TestBase
{
    protected override string ServiceCode => "6178";
    protected override string? ServiceTitle => "MasatPaterhequraFunksioneKushtetuese";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    [Test]
    public void MasatPaterhequraFunksioneKushtetuese()
    {
        ...
        Assert.That(serviceName.Text.Trim(), Is.EqualTo("Masat e patërhequra të pensionit shtetëror suplementar të personave me funksione kushtetuese"),
