...
public class _6180_ : QytetarNidF602TestBase
{
    ...
    public void MasatPaterhequraPilot()
    {
        ...
        Assert.That(serviceName.Text.Trim(),
            Is.EqualTo("Masat e patërhequra të trajtimit të veçantë financiar të pilotëve fluturues në pension"),
        ...
        IWebElement emptyMessage = wait.Until(ExpectedConditions.ElementIsVisible(
            By.XPath("//div[normalize-space()='Nuk gjendet pension suplementar i pa tërhequr!']")));
