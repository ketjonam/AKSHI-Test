...
[Category("MEPJ")]
[Category("9775")]
public class _9775_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "9775";
    protected override string? ServiceTitle => "VertetimKonsullorINdryshem";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName = "Aplikim për Vërtetim Konsullor, i ndryshëm";
    private const string DocumentPath = @"C:\Users\Kreatx\Downloads\Test Dokument.pdf.pdf";
    private const string IdentifikimiUploadId = "docIdentifikimi_vertCustUpload";
    private const string MbeshteteseUploadId = "docMbeshtetese_vertCustUpload";
    ...
    public void VertetimKonsullorINdryshem()
    {
        ...
        IWebElement kerkesa = wait.Until(ExpectedConditions.ElementExists(
        ...
        FillInput(wait.Until(ExpectedConditions.ElementExists(
            By.CssSelector("form textarea.ealb-input"))), "test");
        ...
        AssertDocumentUpload(MbeshteteseUploadId,
            "Dokumente të tjera mbështetëse me të cilat të justifikoje mjaftueshëm nevojën për lëshimin e vërtetimit",
            required: false);
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle, bool required)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-9775"));
