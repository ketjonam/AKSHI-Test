...
[Category("9778")]
[Category("FailCase")]
public class _9778_FailCase_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "9778";
    protected override string? ServiceTitle => "LidhjeMarteseMeShtetasTeHuaj_FailCase_ReturnsUiMessage";
    ...
    public void LidhjeMarteseMeShtetasTeHuaj_FailCase_ReturnsUiMessage()
    {
        ...
        driver.FindElement(By.Name("wifeNid")).SendKeys(Settings.Qytetar.Username);
