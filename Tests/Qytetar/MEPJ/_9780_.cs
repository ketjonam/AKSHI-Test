...
[Category("MEPJ")]
[Category("9780")]
public class _9780_ : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "9780";
    protected override string? ServiceTitle => "NjehesimiiKopjesMeOrigjinalin";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName = "Aplikim për njësimin e kopjes me origjinalin";
    private const string DocumentPath = @"C:\Users\Kreatx\Downloads\Test Dokument.pdf.pdf";
    private const string IdentifikimiUploadId = "doc1Upload";
    private const string DokumentiOrigjinalUploadId = "doc2Upload";
    ...
    public void NjehesimiiKopjesMeOrigjinalin()
    {
        ...
        IWebElement consularOffice = FindByName("consulate");
        ...
        IWebElement Step4Title = WaitForStepTitle("KËRKESA PËR NJËSIMIN E KOPJES ME ORIGJINALIN");
        Assert.That(Step4Title.Text.Trim().ToUpperInvariant(),
            Does.StartWith("KËRKESA PËR NJËSIMIN E KOPJES ME ORIGJINALIN"));
        ...
        IWebElement kerkesa = FindById("kerkesaTextArea");
        ...
        Assert.That(FindLabel("Kërkesa për njësimin e kopjes me origjinalin").Text, Does.Contain("*"));
        ...
        FillInput(FindById("kerkesaTextArea"), "test");
        ...
        AssertDocumentUpload(DokumentiOrigjinalUploadId,
            "Dokumenti origjinal (që kërkohet të njehsohet)", required: true);
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle, bool required)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-9780"));
