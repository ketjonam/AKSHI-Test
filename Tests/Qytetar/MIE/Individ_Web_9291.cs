...
[Category("MIE")]
[Category("9291")]
public class Individ_Web_9291 : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "9291";
    protected override string? ServiceTitle => "Aplikim_i_Ri_9291";
    protected override ServiceStartMode StartMode => ServiceStartMode.NewApplication;
    protected override bool StartServiceOnSetup => false;

    private const string ExpectedServiceName =
        "Pajisja me dublikatë të licencës individuale në fushën e vlerësimit të pasurive të paluajtshme (online)";
    ...
    public void Aplikim_i_Ri_9291()
    {
        ...
        AssertDisabledInput("gjCiv", "Martuar");
        AssertDisabledInput("vendlindja", "Korçë");
        AssertDisabledInput("datelindja", "13.4.1993");
        ...
        IWebElement contactNumber = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("contactNumber")));
        Assert.That(contactNumber.GetAttribute("disabled"), Is.Null);
        Assert.That(contactNumber.GetAttribute("value").Trim(), Is.EqualTo(string.Empty));
        ...
        AssertDisabledInput("phoneNumber", "+355697008820");
        ...
        Assert.That(license.Options[1].Text.Trim(),
            Is.EqualTo("Për tokë bujqësore, tokë pyjore, kullotë, livadh dhe tokë të pafrytshme"));
        ...
        IWebElement remarks = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("remarks")));
        Assert.That(remarks.GetAttribute("maxlength"), Is.EqualTo("200"));
        Assert.That(remarks.GetAttribute("value").Trim(), Is.EqualTo(string.Empty));

        IWebElement addressDetails = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("addressDetails")));
        Assert.That(addressDetails.GetAttribute("value").Trim(), Is.EqualTo(string.Empty));
        ...
        Log("Assert document-upload Vetëdeklarimi");
        ...
        Log("Ngarko Vetëdeklarimi");
        UploadDocument("fileVetedeklarimiUpload", documentPath);
        ...
        SafeClick(By.Id("agreementCheckbox"));
        ...
        //Assert.That(referenceNumber.Text, Does.Contain("9291-"));
    ...
    private void AssertDocumentUpload(string uploadId, string documentTitle)
    {
        ...
        Assert.That(docUpload.GetAttribute("application-reference"), Is.EqualTo("docstreamv2-9291"));
