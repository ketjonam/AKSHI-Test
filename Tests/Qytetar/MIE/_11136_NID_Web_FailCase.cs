...
[Category("11136")]
[Category("FailCase")]
public class _11136_NID_Web_FailCase : QytetarNidJ557TestBase
{
    protected override string ServiceCode => "11136";
    protected override string? ServiceTitle => "Aplikim_i_Ri_NID_11136_FailCase_ReturnsUiMessage";
...
Log("===== TEST START (FAIL CASE) =====");
    ...
    private void SelectThirdLevelCategoryByText(IWebDriver driver,
        WebDriverWait wait,
